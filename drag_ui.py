...
from utils.ui_utils_nocontrol_sam_area_dmask_noiseloss import get_points, undo_points
from utils.ui_utils_nocontrol_sam_area_dmask_noiseloss import clear_all, store_img, train_lora_interface, run_drag
from utils.ui_utils_nocontrol_sam_area_dmask_noiseloss import clear_all_gen, store_img_gen, gen_img, run_drag_gen
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        gr.Markdown("""
        # Official Implementation of [AdaptiveDrag]
        """)
    ...
    with gr.Tab(label="Editing Real Image"):
        ...
        with gr.Tab("Base Model Config"):
            with gr.Row():
                ...
                model_path = gr.Dropdown(value="huggingface/runwayml/stable-diffusion-v1-5",
                ...
                vae_path = gr.Dropdown(value="default",
                    label="VAE choice",
                    choices=["default",
                    "huggingface/stabilityai/sd-vae-ft-mse"] + local_models_choice
                )
    ...
    with gr.Tab(label="Editing Generated Image"):
        ...
        with gr.Tab("Generation Config"):
            with gr.Row():
                ...
                local_models_choice = \
                    [os.path.join(local_models_dir,d) for d in os.listdir(local_models_dir) if os.path.isdir(os.path.join(local_models_dir,d))]
                model_path_gen = gr.Dropdown(value="huggingface/runwayml/stable-diffusion-v1-5",
                    label="Diffusion Model Path",
                    choices=[
                        "runwayml/stable-diffusion-v1-5",
                        "gsdf/Counterfeit-V2.5",
